...
import { getFaculty, getFacultyById, createFaculty, updateFaculty, deleteFaculty, getMyFacultyProfile } from '../controllers/faculty.controller';
import { verifyToken } from '../middlewares/auth';
import { requireRole } from '../middlewares/roleGuard';
const router = Router();
router.get('/', verifyToken, requireRole('admin'), getFaculty);
router.get('/me/profile', verifyToken, requireRole('faculty'), getMyFacultyProfile);
